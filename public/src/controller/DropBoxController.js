class DropBoxController {
  ...
  connectFirebase() {
    const firebaseConfig = {
      apiKey: "AIzaSyAEJgS5MyT69l2qeeV7dhro_Q2mzFp8T3s",
      authDomain: "clonedropbox-a1065.firebaseapp.com",
      databaseURL: "https://clonedropbox-a1065-default-rtdb.firebaseio.com",
      projectId: "clonedropbox-a1065",
      storageBucket: "clonedropbox-a1065.appspot.com",
      messagingSenderId: "250950838725",
      appId: "1:250950838725:web:5a9eebb9ef83bb38fe83ac"
    };
  ...
  removeTask() {
    ...
    this.getSelectedItens().forEach(li => {
  ...
  getFileIconView(file) {
    switch (file.type) {
      case 'folder':
        return `
        <svg width="160" height="160" viewBox="0 0 160 160" class="mc-icon-template-content tile_preview tile_preview--icon">
